...
export default function Profile() {
  return (
        <div className='flex flex-col justify-center items-center bg-teal-50 dark:bg-[#18191a]'>
            ...
            <select name="" id="" className='border-b-2 border-teal-700 text-teal-700 bg-teal-50 dark:bg-[#18191a] dark:border-[#b1b4b7] dark:text-[#b1b4b7]' >
...
<div className='h-max lg:w-1/2 lg:border-teal-950 lg:border-x-2 dark:lg:border-[#b1b4b7]'>
 <PostSend />
<Posts/>
</div>
